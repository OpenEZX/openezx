...
/* USB2.0 */
#define GPIO79_USB20_NCS3	MFP_CFG_OUT(GPIO79, AF2, DRIVE_LOW)
#define GPIO18_HDD_USB20_READY	MFP_CFG_IN(GPIO18, AF1)
#define GPIO49_NPWE		MFP_CFG_OUT(GPIO49, AF2, DRIVE_LOW)
#define GPIO20_USB20_DREQ0	MFP_CFG_IN(GPIO20, AF1)
#define GPIO19_USB20_INT	MFP_CFG_IN(GPIO19, AF0)
#define GPIO94_USB20_SWITCH	MFP_CFG_OUT(GPIO94, AF0, DRIVE_LOW)
